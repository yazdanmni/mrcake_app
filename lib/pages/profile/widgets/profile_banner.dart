...
class _ProfileBannerState extends State<ProfileBanner> {
  ...
  // اندازه پیشنهادی برای تصویر اصلی
  ...
  void didUpdateWidget(
    covariant ProfileBanner oldWidget,
  ) {
